...
Or watch this [server gif](https://github.com/SuperDasMan/social-net-api/tree/main/assets/videos/SNA-Server.gif)![server gif](https://github.com/SuperDasMan/social-net-api/tree/main/assets/videos/SNA-Server.gif) and this [API gif](https://github.com/SuperDasMan/social-net-api/tree/main/assets/videos/SNA-Server.gif)![API gif](https://github.com/SuperDasMan/social-net-api/tree/main/assets/videos/SNA-Server.gif) for a glimpse of the app in action.
